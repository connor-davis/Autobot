...
labelDescription = ttb.Label(text="Autobot Macros help you with lazily performing the silent shot and slide cancel.",
...
checkboxExitScope = ttb.Checkbutton(master=frameSilentShot, bootstyle="success-round-toggle",
...
themeCombobox = ttb.Combobox(master=frameSettings, values=["darkly", "vapor", "flatly", "pulse"], bootstyle="success")
